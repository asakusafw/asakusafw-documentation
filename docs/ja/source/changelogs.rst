...
..  list-table:: Bundled Components
    ...
    * - Asakusa Framework Distribution
      - 0.10.4 (|VERSION_UP|)
      - [ :milestone-asakusafw-distribution:`0.10.4` ]
    * - Asakusa Framework Core
      - 0.10.4 (|VERSION_UP|)
      - [ :milestone-asakusafw:`0.10.4` ]
    * - Asakusa Framework Language Toolset
      - 0.5.4 (|VERSION_UP|)
      - [ :milestone-asakusafw-compiler:`0.5.4` ]
    * - Asakusa on Spark
      - 0.5.4 (|VERSION_UP|)
      - [ :milestone-asakusafw-spark:`0.5.4` ]
    * - |M3BP_FEATURE|
      - 0.3.4 (|VERSION_UP|)
      - [ :milestone-asakusafw-m3bp:`0.3.4` ]
    * - |M3BP_ENGINE|
      - 0.1.2
      - [ :milestone-m3bp:`0.1.2` ]
    * - Asakusa on MapReduce
      - 0.10.4 (|VERSION_UP|)
      - [ :milestone-asakusafw-mapreduce:`0.10.4` ] (deprecated)
