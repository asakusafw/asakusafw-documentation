...
..  attention::
    `Amazon EMR`_ は頻繁にバージョンアップが行われるため、バージョンによっては本書と内容が異なる可能性があります。
...
2. EMRのクラスターリスト画面で、画面上部の :guilabel:`クラスターを作成` ボタンを押下する。
    ...
    ..  figure:: images/emr-console-menu-createcluster.png
        :width: 80%
...
3. EMRクラスターの起動パラメータを入力する
   ...
   コンソールで指定する起動パラメータについては、 後述の `起動パラメータ`_ で説明しているのでこちらも参照してください。
    ...
    ..  figure:: images/emr-console-create-cluster.png
        :width: 80%
...
..  figure:: images/emr-console-cluster-starting.png
    :width: 80%
...
1. 画面上部の :guilabel:`ステップの追加` ボタンを押下する
    ...
    ..  figure:: images/emr-console-menu-addstep.png
        :width: 80%

2. :guilabel:`ステップの追加` ダイアログで以下の通りに入力し、 :guilabel:`追加` ボタンを押下する

    ..  figure:: images/emr-console-addstep-deploy.png
        :width: 100%
...
..  figure:: images/emr-console-complete-deploy.png
    :width: 100%
...
2. :guilabel:`ステップの追加` ダイアログで以下の通りに入力し、 :guilabel:`追加` ボタンを押下する
    ...
    ..  figure:: images/emr-console-addstep-runbatch.png
        :width: 100%
...
..  figure:: images/emr-console-running-batch.png
    :width: 100%
...
..  figure:: images/emr-console-steplog.png
    :width: 30%
...
1. クラスター詳細画面上部の :guilabel:`Terminate` ボタンを押下する。
    ...
    ..  figure:: images/emr-console-menu-terminate.png
        :width: 80%
