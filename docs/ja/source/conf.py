...
extlinks = {
    ...
    'apiref': ('http://docs.asakusafw.com/0.10.1/release/api/%s', None),
    'epub': ('http://docs.asakusafw.com/0.10.1/release/ja/epub/%s', None),
    'basic-tutorial': ('http://docs.asakusafw.com/basic-tutorial/0.10/release/ja/html/%s', None),
}
javadoclinks = {
    'asakusafw-javadoc': ('http://docs.asakusafw.com/0.10.1/release/api/%s.html', ""),
    'asakusa-gradle-groovydoc': ('http://docs.asakusafw.com/0.10.1/release/gradle-plugins/%s.html', ""),
    'asakusa-spark-gradle-groovydoc': ('http://docs.asakusafw.com/asakusa-on-spark/0.5.1/release/gradle-plugins/%s.html', ""),
    'asakusa-m3bp-gradle-groovydoc': ('http://docs.asakusafw.com/asakusa-on-m3bp/0.3.1/release/gradle-plugins/%s.html', ""),
}
...
copyright = u'2011-2017, Asakusa Framework Team'
