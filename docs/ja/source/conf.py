...
extlinks = {
    ...
    'apiref': ('https://docs.asakusafw.com/0.10.5/release/api/%s', None),
    'epub': ('https://docs.asakusafw.com/0.10.5/release/ja/epub/%s', None),
    'basic-tutorial': ('https://docs.asakusafw.com/basic-tutorial/0.10/release/ja/html/%s', None),
}
javadoclinks = {
    'asakusafw-javadoc': ('https://docs.asakusafw.com/0.10.5/release/api/%s.html', ""),
    'asakusa-gradle-groovydoc': ('https://docs.asakusafw.com/0.10.5/release/gradle-plugins/%s.html', ""),
    'asakusa-spark-gradle-groovydoc': ('https://docs.asakusafw.com/asakusa-on-spark/0.5.5/release/gradle-plugins/%s.html', ""),
    'asakusa-m3bp-gradle-groovydoc': ('https://docs.asakusafw.com/asakusa-on-m3bp/0.3.5/release/gradle-plugins/%s.html', ""),
}
