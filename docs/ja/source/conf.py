# -*- coding: utf-8 -*-
#
# Asakusa Framework documentation build configuration file, created by
# sphinx-quickstart on Wed May 18 11:38:42 2011.
#
...
# autogenerated file.
#
# All configuration values have a default; values that are commented outcl
...
extlinks = {
    ...
    'apiref': ('https://docs.asakusafw.com/0.10.4/release/api/%s', None),
    'epub': ('https://docs.asakusafw.com/0.10.4/release/ja/epub/%s', None),
    'basic-tutorial': ('https://docs.asakusafw.com/basic-tutorial/0.10/release/ja/html/%s', None),
}
javadoclinks = {
    'asakusafw-javadoc': ('https://docs.asakusafw.com/0.10.4/release/api/%s.html', ""),
    'asakusa-gradle-groovydoc': ('https://docs.asakusafw.com/0.10.4/release/gradle-plugins/%s.html', ""),
    'asakusa-spark-gradle-groovydoc': ('https://docs.asakusafw.com/asakusa-on-spark/0.5.4/release/gradle-plugins/%s.html', ""),
    'asakusa-m3bp-gradle-groovydoc': ('https://docs.asakusafw.com/asakusa-on-m3bp/0.3.4/release/gradle-plugins/%s.html', ""),
}
...
version = '0.10.4'
# The full version, including alpha/beta/rc tags3
release = '0.10.4'
...
html_title = project + " " + release + " documentation (revision-2)"
...
htmlhelp_basename = 'AsakusaFrameworkdoc'
