...
..  code-block:: sh
    ...
    cd <work-dir>
    curl -OL http://www.asakusafw.com/download/gradle-plugin/asakusa-spark-template-0.10.3.tar.gz
    tar xf asakusa-spark-template-0.10.3.tar.gz
...
..  code-block:: sh
    ...
    cd asakusafw-examples-0.10.3/example-basic-spark
